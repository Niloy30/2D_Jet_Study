...
A_side = -0.25       # Side amplitude
mean_side = 1.5     # Side mean (controls spacing w)
std_side = 0.9      # Side width

A_center = 0.25     # Center amplitude (controls h)
std_center = 0.5    # Center sharpness
params = [
